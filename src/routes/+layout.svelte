...
<nav
  class="mobile:h-[100px] fixed bottom-0 left-0 w-full flex justify-between px-4 py-10 text-black bg-transparent mobile:fixed mobile:top-0 mobile:left-0 mobile:w-full mobile:flex mobile:justify-between mobile:items-center mobile:px-[2rem] mobile:py-[4rem] mobile:bg-white"
  style="z-index: 2001;"
>
  <div

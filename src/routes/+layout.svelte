<script>
  ...
  >
    <div class="flex flex-col ml-8 text-[1.125rem]" style="z-index: 2001;">
      <p class="mb-2 hover:cursor-pointer toggle-menu-btn" on:click={toggleWorkMenu}>work</p>
      <p class="mb-2 hover:cursor-pointer">contact</p>
    </div>
    <div class="mr-8 flex flex-col items-start justify-end" style="z-index: 2001;">
      <p class="text-[1.5rem] hover:cursor-pointer toggle-menu-btn" on:click={toggleAboutMenu}>
        Kana Motojima
      </p>
    </div>
  </nav>
